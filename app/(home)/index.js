        ...
        <View style={{ padding: 12 }}>
          ...
          <View style={{ marginTop: 20, flexDirection: "row", alignItems: "center", gap: 20 }}>
            <Pressable
              ...
              style={{ flex: 1, backgroundColor: "#D3CCE3", padding: 12, borderRadius: 6, alignItems: "center", justifyContent: "center" }}>
            ...
            <Pressable style={{ flex: 1, backgroundColor: "#D3CCE3", padding: 12, borderRadius: 6, alignItems: "center", justifyContent: "center" }}>
              <View style={{ width: 50, height: 50, borderRadius: 25, backgroundColor: "white", alignItems: "center", justifyContent: "center" }}>
                <Ionicons name="ios-people-sharp" size={24} color="black" />
              </View>
          ...
          <View style={{ marginTop: 20, flexDirection: "row", alignItems: "center", gap: 13 }}>
            <View style={{ flex: 1, backgroundColor: "#f79d80", borderRadius: 6, padding: 12, alignItems: "center", justifyContent: "center" }}>
              <View style={{ width: 35, height: 35, borderRadius: 7, backgroundColor: "white", alignItems: "center", justifyContent: "center" }}>
